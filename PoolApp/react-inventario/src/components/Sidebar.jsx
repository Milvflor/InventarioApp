...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <aside id="default-sidebar" className="flex z-10 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                  ...
                  className="flex cursor-pointer items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap">Lotes</span>
                  </a>
              </li>
              <li>
                  <a
